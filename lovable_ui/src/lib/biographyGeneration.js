const MIN_READY_TOPIC_PROGRESS = 85;
const NEEDS_STORY_MESSAGE = '先去讲讲您的故事吧，至少需要一个主题进度达到85%。';
...
export function getMaxTopicProgress(topics) {
...
export function getLatestBiography(biographies) {
...
// 回忆录生成门槛模块：统一用户端交互判断，服务端也有同名 CommonJS 模块做接口兜底。
export function buildBiographyGenerationDecision({ topics = [], biographies = [] } = {}) {
