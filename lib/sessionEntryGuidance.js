...
function buildFirstTimeSpeechText(userName, topicTitle) {
    ...
    return `${greeting}我们先从一个简单的话题开始吧。您可以从“${topicTitle}”开始，也可以在右边选择其他想聊的主题。选好后，按住下面的话筒，像聊天一样讲。我会帮您慢慢整理成回忆录。`;
}
...
function buildFirstTimeGuidance(input) {
    ...
    return {
        ...
        topicId,
        topicTitle,
        displayText: `我们可以先从“${topicTitle}”开始。您也可以在右边选择其他想聊的主题。选好后，按住下面的话筒，像聊天一样讲。`,
