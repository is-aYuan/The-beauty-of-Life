...
- userFacingCue 是一句可以直接朗读给用户听的自然承接句，必须用第二人称，比如“您上次提到第一份工作是在五金店帮忙”。
- userFacingCue 禁止写“用户提到...”“AI已追问...”“尚未提供...”“未提供...”“拒绝...”“缺失信息...”“对话主要围绕...”等系统分析语。
- 如果本轮没有形成可展示记忆，就返回空字符串。
...
严格输出 JSON，不要输出任何其他文字：
{
  "topicAnalysis": {
    ...
    "concreteStories": [],
    "missingInfo": [],
    "userFacingCue": "一句可以直接朗读给用户听的自然承接句，没有就留空",
